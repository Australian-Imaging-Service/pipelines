...
title: mri.human.neuro.bidsapp.mriqc
weight: 10
...
|Key|Value|
|---|-----|
|Name|mri.human.neuro.bidsapp.mriqc|
...
|`t2w`|<span data-toggle="tooltip" data-placement="bottom" title="medimage/dicom-dir\|medimage/dicom-series\|medimage/nifti-gz-x (optional)" aria-label="medimage/dicom-dir\|medimage/dicom-series\|medimage/nifti-gz-x (optional)">medimage/dicom-dir\|medimage/dicom-series\|medimage/nifti-gz-x (optional)</span>|N|T2-weighted anatomical MRI|
|`bold`|<span data-toggle="tooltip" data-placement="bottom" title="medimage/dicom-dir\|medimage/dicom-series\|medimage/nifti-gz-x (optional)" aria-label="medimage/dicom-dir\|medimage/dicom-series\|medimage/nifti-gz-x (optional)">medimage/dicom-dir\|medimage/dicom-series\|medimage/nifti-gz-x (optional)</span>|N|Resting-state functional MRI|
